...
export type PinnedRepositoryListType = (null | ({ __typename?: "Repository" } & Pick<Node & ProjectOwner & PackageOwner & Subscribable & Starrable & UniformResourceLocatable & RepositoryInfo & {
...
}, "id" | "name" | "description"> & { primaryLanguage?: Maybe<{ __typename?: "Language" } & Pick<Language, "color" | "name">>; stargazers: { __typename?: "StargazerConnection" } & Pick<StargazerConnection, "totalCount">; forks: { __typename?: "RepositoryConnection" } & Pick<RepositoryConnection, "totalCount"> }))[] | undefined;
